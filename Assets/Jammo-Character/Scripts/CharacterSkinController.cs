...
public class CharacterSkinController : MonoBehaviour
{
    ...
    private InputAction HappyAction;
    private InputAction AngryAction;

    private InputAction DeadAction;
    ...
    void Start()
    {
        ...
        HappyAction = InputActions.FindAction("Happy");
        AngryAction = InputActions.FindAction("Angry");
        DeadAction = InputActions.FindAction("Dead");
    }
